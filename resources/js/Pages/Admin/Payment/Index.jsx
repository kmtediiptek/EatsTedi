...
export default function Index({ total_payments, ...props }) {
    ...
    const handleSearch = (e) => {
        ...
        router.get(`/admin/setting/payment`, {
                                ...
                                <tr className="bg-white border-b text-gray-500" key={index}>
                                    ...
                                    <Table.Td className="w-10" >
                                        <div className='flex flex-nowrap gap-2'>
                                            <ActionButton className='w-8 h-8 bg-yellow-400' type="button" onClick={() => openModalTable(payment.slug, "edit")}><IconEdit size={18} /></ActionButton>
                                            <ActionButton className='w-8 h-8 bg-red-500' type="button" onClick={() => openToast(payment.slug, 'Payment ' + payment.name)}><IconTrash size={18} /></ActionButton>
                                        </div>
                                    </Table.Td>
                                </tr>
                            ))}
