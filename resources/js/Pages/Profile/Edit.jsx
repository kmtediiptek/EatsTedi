                                ...
                                <div className="p-4 w-full space-y-8 rounded border border-1 border-gray-300">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-secondary">
                                            ...
                                            statistical data. Randa can record
                                            finances, orders and even print
                                            sales results. The following are
                                                ...
                                                (monthData, index) => {
                                                    ...
                                                    monthData.days.forEach(
                                                        (day) => {
                                                            checkboxes[
                                                                day.day - 1
                                                            ] = true; // Mark checkboxes for days with salary
                                                        }
                                                    );
                                                                ...
                                                                <div className="grid grid-cols-5 w-32 h-48">
                                                                    {checkboxes.map(
                                                                        (
                                                                            ...
                                                                            >
                                                                                <input
                                                                                    className="rounded w-6 border border-gray-400 h-6 text-green-600"
                                                                                    type="checkbox"
                                                                                    checked={
                                                                                        checked
                                                                                    }
