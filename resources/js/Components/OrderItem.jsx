        ...
        <div className="flex gap-x-4 p-2 border border-gray-300 rounded text-white" >
            ...
            <div className="flex">
                ...
                <div className='flex items-end flex-col flex-1 gap-y-2 h-full justify-between h-16 w-32 text-slate-800'>
                    <h5 className={`font-semibold text-sm flex items-center gap-x-2 py-1 h-full px-2 rounded text-white ${invoice.status === 1 ? 'bg-green-500' : 'bg-yellow-400'}`}>{invoice.status === 1 ? <>
