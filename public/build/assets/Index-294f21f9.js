...
import { A as le } from "./ActionLink-e34be557.js";
        ...
        children: [
            a("div", {
                ...
                children: [
                    ...
                    l.name ? e(S, { className: "", value: l.name }) : null,
                ],
            }),
            e("div", {
                className: "mb-4",
...
function ce({ total_tables: r, ...f }) {
    const { data: l, meta: c, links: d } = f.tables,
        [I, k] = o.useState(""),
        { delete: M, post: j, put: F, data: b, setData: m } = H({ name: "" });
    let [D, i] = o.useState(!1),
        [P, u] = o.useState(!1);
    const [z, E] = o.useState(""),
        ...
        [x, h] = o.useState("");
    function v(t, n) {
        if ((i(!0), E("Table"), U(n), h(t), t)) {
            const w = l.find((Y) => Y.slug === t);
    ...
    const _ = (t) => {
            t.preventDefault(),
                j(route("admin.table.index"), {
                    data: b,
                    onSuccess: () => {
                        N.success("Table has been created!"),
                            i(!1),
                            m({ name: "", status: "" });
                    },
                });
        ...
        q = (t) => (n) => {
            n.preventDefault(),
                F(route("admin.table.update", t), {
                    ...b,
                    onSuccess: () => {
                        N.success("Table has been updated!"), i(!1);
                    },
                });
        },
        V = (t) => {
            M(route("admin.table.destroy", t), {
                onSuccess: () => {
                    N.success("Table has been deleted!"), u(!1);
                },
            });
        },
        W = (t) => {
            ...
            a(te, {
                children: [
                    ...
                    a("div", {
                        ...
                        children: [
                            a("div", {
                                ...
                                children: [
                                    e(le, { href: route("admin.dashboard") }),
                                    e(y, {
                                        onClick: () => v("", "create"),
                                        type: "button",
                    ...
                    e(ae, {
                        ...
                        title: z,
                        children: a("form", {
                            onSubmit: g == "create" ? _ : q(x),
                            className: "mt-6",
                            children: [
                                e(oe, { data: b, setData: m }),
                                a("div", {
                    ...
                    e(ee, {
                        ...
                        children: a("div", {
                            ...
                            children: [
                                e(A, { onClick: () => Q(), children: "No" }),
                                e(C, { onClick: () => V(x), children: "Yes" }),
                            ],
                        }),
                    }),
                ],
