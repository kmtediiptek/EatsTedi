...
import { I as y } from "./index-f4d5d2b2.js";
import { t as b } from "./transition-42c9a528.js";
import { T as w } from "./TextInput-01542f12.js";
const p = d.createContext(),
    o = ({ children: t }) => {
        ...
        return e(p.Provider, {
            value: { open: i, setOpen: n, toggleOpen: a },
            children: e("div", { className: "relative", children: t }),
        });
    },
    N = ({ children: t }) => {
        const { open: i, setOpen: n, toggleOpen: a } = d.useContext(p);
        return r(f, {
            children: [
                e("div", { onClick: a, children: t }),
                i &&
                    e("div", {
    ...
    k = ({
        align: t = "right",
        width: i = "48",
        contentClasses: n = "py-1 bg-white",
        children: a,
    }) => {
        const { open: l, setOpen: g } = d.useContext(p);
        let u = "origin-top";
        t === "left"
            ? (u = "origin-top-left left-0")
            : t === "right" && (u = "origin-top-right right-0");
        let s = "";
        return (
            i === "48" && (s = "w-48"),
            e(f, {
                children: e(b, {
                    ...
                    children: e("div", {
                        className: `absolute z-50 mt-2 rounded shadow-lg ${u} ${s}`,
                        onClick: () => g(!1),
                        children: e("div", {
                            className:
...
o.Content = k;
o.Link = C;
function m({ active: t = !1, className: i = "", children: n, ...a }) {
    return e(h, {
        ...a,
        className:
...
function c({ active: t = !1, className: i = "", children: n, ...a }) {
    return e(h, {
        ...a,
...
function L() {
    const { auth: t } = x().props,
        ...
        u = (s) => {
            s.preventDefault(),
                g(s.target.value),
                v.get(i, { search: l }, { preserveState: !0 });
        };
    return r("nav", {
        className:
            "bg-white fixed z-[999] top-0 border-b border-gray-300 w-full",
        children: [
            e("div", {
                className: "max-w-8xl mx-auto px-4 sm:px-4 lg:px-8",
                children: r("div", {
                    className: "flex justify-between h-16",
                    children: [
                        r("div", {
                            className: "flex w-full md:w-3/4 justify-between",
                            children: [
                                r("div", {
                                ...
                                r("div", {
                                    className:
                                        "hidden sm:-my-px sm:flex flex justify-between gap-8",
                                    children: [
                                        e(m, {
                        ...
                        e("div", {
                            className:
                                "hidden w-1/4 flex justify-end sm:flex sm:items-center",
                            children: e("div", {
                                children: r(o, {
                                    children: [
                                        e(o.Trigger, {
                        ...
                        e("div", {
                            ...
                            children: e("button", {
                                onClick: () => a((s) => !s),
                                className:
                                    "inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-secondary hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-secondary transition duration-150 ease-in-out",
                                children: r("svg", {
                                    className: "h-6 w-6",
                                    stroke: "currentColor",
                                    fill: "none",
            ...
            r("div", {
                className: (n ? "block" : "hidden") + " sm:hidden",
                children: [
                    r("div", {
                        ...
                        children: [
                            r("div", {
                                ...
                                children: [
                                    ...
                                    e("div", {
                                        className:
                                            "font-medium text-sm text-secondary",
