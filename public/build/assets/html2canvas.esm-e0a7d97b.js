...
var yn =
        ...
        return (
            ...
            (e.prototype.consumeEscapedCodePoint = function () {
                ...
                if (MA(A)) {
                    for (
                        var t = S(A);
                        MA(this.peekCodePoint(0)) && t.length < 6;
    ...
    UB = (function () {
        ...
        return (
            ...
            (e.prototype.consumeSimpleBlock = function (A) {
                for (
                    var t = { type: A, values: [] }, r = this.consumeToken();
                    ;
    ...
    dA = function (e, A, t, r) {
        return (
            ((e << 24) | (A << 16) | (t << 8) | (Math.round(r * 255) << 0)) >>>
            0
        );
    },
    Et = function (e, A) {
        ...
        return (
            sA(A).forEach(function (B, n) {
                if (n === 0) {
                    ...
                    if (
                        s.type === 20 &&
                        ["top", "left", "right", "bottom"].indexOf(s.value) !==
                            -1
                    ) {
                        t = vB(B);
                        return;
    ...
    Ki = (function () {
        function e(A, t) {
            ...
            (this.animationDuration = U(A, Ei, t.animationDuration)),
                ...
                (this.borderBottomRightRadius = U(
                    A,
                    Ea,
                    t.borderBottomRightRadius
                )),
                (this.borderBottomLeftRadius = U(
                    A,
                    Ha,
            ...
            (this.overflowX = n[0]),
                ...
                (this.textDecorationColor = U(
                    A,
                    wi,
                    (r = t.textDecorationColor) !== null && r !== void 0
                        ? r
                        : t.color
                )),
                ...
                (this.webkitTextStrokeColor = U(
                    A,
                    vi,
                    t.webkitTextStrokeColor
                )),
                (this.webkitTextStrokeWidth = U(
                    A,
                    yi,
...
var qi = 1,
        ...
        return (
            ...
            Xt(s)
                ...
                .then(function (i) {
                    return (
                        r.drawImage(i, 0, 0),
                        Nt(r.getImageData(0, 0, t, t).data)
                    );
                })
                .catch(function () {
                    return !1;
    ...
    N = {
        ...
        get SUPPORT_SVG_DRAWING() {
            var e = oo(document);
            return (
                Object.defineProperty(N, "SUPPORT_SVG_DRAWING", { value: e }), e
            );
        },
        get SUPPORT_FOREIGNOBJECT_DRAWING() {
            var e =
                ...
                typeof window.fetch == "function"
                    ...
                    : Promise.resolve(!1);
            return (
                Object.defineProperty(N, "SUPPORT_FOREIGNOBJECT_DRAWING", {
                    value: e,
                }),
                e
            );
        ...
        get SUPPORT_CORS_IMAGES() {
            var e = ao();
            return (
                Object.defineProperty(N, "SUPPORT_CORS_IMAGES", { value: e }), e
            );
        },
        ...
        get SUPPORT_CORS_XHR() {
            ...
            return (
                Object.defineProperty(N, "SUPPORT_CORS_XHR", { value: e }), e
            );
        },
    ...
    VB = (function (e) {
        ...
        function A(t, r) {
            ...
            return (
                ...
                (B.svg =
                    "data:image/svg+xml," +
                    encodeURIComponent(n.serializeToString(r))),
    ...
    kr = (function (e) {
        ...
        function A(t, r) {
            ...
            return (
                (B.start = r.start),
                (B.reversed =
                    typeof r.reversed == "boolean" && r.reversed === !0),
                B
            );
        }
        return A;
    ...
    Io = function (e) {
        var A =
            e.type === vo ? new Array(e.value.length + 1).join("•") : e.value;
    ...
    $t = (function () {
        ...
        return (
                ...
                try {
                    ...
                    if (t && t.cssRules) {
                        var r = [].slice
                                .call(t.cssRules, 0)
                                .reduce(function (n, s) {
                                    return s && typeof s.cssText == "string"
                                        ? n + s.cssText
                                        : n;
                                }, ""),
                            B = A.cloneNode(!1);
            ...
            (e.prototype.createVideoClone = function (A) {
                ...
                return (
                    (B.width = A.offsetWidth), (B.height = A.offsetHeight), B
                );
            }),
            ...
            (e.prototype.cloneChildNodes = function (A, t, r) {
                for (
                    ...
                    if (
                        _A(n) &&
                        jB(n) &&
                        typeof n.assignedNodes == "function"
                    ) {
            ...
            (e.prototype.cloneNode = function (A, t) {
                ...
                if (r && _A(A) && (Yr(A) || Ne(A))) {
                    ...
                    return (
                        Q && B.appendChild(Q),
                        this.counters.pop(a),
                        ((n && (this.options.copyStyles || Ne(A)) && !qB(A)) ||
                            t) &&
                            Ir(n, B),
                                ...
                                if (g.type === 0)
                                    ...
                                    if (g.name === "attr") {
                                        ...
                                        var c = g.values.filter(PA),
                                            ...
                                            H = c[1];
                                        if (C && D(C)) {
                                            var h = n.counters.getCounterValue(
                                                    C.value
                                                ),
                                                F =
                                                    H && D(H)
                                        ...
                                        var K = g.values.filter(PA),
                                            ...
                                            H = K[2];
                                        if (C && D(C)) {
                                            var d = n.counters.getCounterValues(
                                                    C.value
                                                ),
                                                l =
                                                    H && D(H)
...
var Go = function (e, A) {
    ...
    Ir = function (e, A) {
        for (var t = e.length - 1; t >= 0; t--) {
            var r = e.item(t);
            Xo.indexOf(r) === -1 &&
                A.style.setProperty(r, e.getPropertyValue(r));
        }
        return A;
    },
    _o = function (e) {
        ...
        return (
            (e.prototype.subdivide = function (A, t) {
                var r = RA(this.start, this.startControl, A),
                    ...
                    a = RA(s, i, A);
                return t
                    ? new e(this.start, r, s, a)
                    : new e(a, i, n, this.end);
            }),
            (e.prototype.add = function (A, t) {
                return new e(
                    this.start.add(A, t),
...
var x = function (e, A, t, r, B) {
        ...
        function e(A, t) {
            ...
            if (this.container.styles.overflowX !== 0) {
                ...
                eB(s, i)
                    ...
                    : (this.effects.push(new Se(s, 2)),
                      this.effects.push(new Se(i, 4)));
            }
        }
        return (
                ...
                for (
                    ...
                    if (t || r.container.styles.position !== 0 || !r.parent) {
                        if (
                            (B.unshift.apply(B, n),
                            (t =
                                [2, 3].indexOf(r.container.styles.position) ===
                                -1),
    ...
    Kr = function (e, A, t) {
        var r = CQ(XA(e.styles.backgroundOrigin, A), e),
            ...
            i = n[1],
            a = re(
                XA(e.styles.backgroundPosition, A),
                r.width - s,
                r.height - i
            ),
                            ...
                            case 19:
                                t.listValue &&
                                    ...
                                    (d = new cA(
                                        ...
                                        r.bounds.width,
                                        yt(n.lineHeight, n.fontSize.number) /
                                            2 +
                                            1
                                    )),
                                    this.renderTextWithLetterSpacing(
                    ...
                    return _(this, function (F) {
                        switch (F.label) {
                            ...
                            case 22:
                                (f = 0),
                                    (c =
                                        t.zeroOrAutoZIndexOrTransformedOrOpacity),
                                    (F.label = 23);
                            case 23:
                                return f < c.length
                ...
                switch (oA.label) {
                    case 0:
                        ...
                        return (
                            (B = {
                                allowTaint:
                                    (y = A.allowTaint) !== null && y !== void 0
                                        ? y
                                        : !1,
                                imageTimeout:
                                    (E = A.imageTimeout) !== null &&
                                    E !== void 0
                                        ? E
                                        : 15e3,
                                proxy: A.proxy,
                                useCORS:
                                    (O = A.useCORS) !== null && O !== void 0
                                        ? O
                                        : !1,
                            }),
                            (n = Lr(
                            ...
                            (s = {
                                windowWidth:
                                    (q = A.windowWidth) !== null && q !== void 0
                                        ...
                                        : r.innerWidth,
                                windowHeight:
                                    (L = A.windowHeight) !== null &&
                                    L !== void 0
                                        ? L
                                        : r.innerHeight,
                                scrollX:
                                    (V = A.scrollX) !== null && V !== void 0
                                        ? V
                                        : r.pageXOffset,
                                scrollY:
                            ...
                            (a = new LQ(n, i)),
                            (o =
                                (Y = A.foreignObjectRendering) !== null &&
                                Y !== void 0
                                    ? Y
                                    : !1),
                            (Q = {
                                allowTaint:
                                    (W = A.allowTaint) !== null && W !== void 0
                                        ? W
                                        : !1,
                                onclone: A.onclone,
                            ...
                            (p = {
                                ...
                                scale:
                                    ...
                                    BA !== void 0
                                        ...
                                        : 1,
                                x:
                                    ((uA = A.x) !== null && uA !== void 0
                                        ? uA
                                        : 0) + h,
                                y:
                                    ((vA = A.y) !== null && vA !== void 0
                                        ? vA
                                        : 0) + F,
                                width:
                                    (yA = A.width) !== null && yA !== void 0
                                        ? yA
                                        : Math.ceil(C),
                                height:
                                    (iA = A.height) !== null && iA !== void 0
                                        ? iA
                                        : Math.ceil(H),
                            }),
                            o
