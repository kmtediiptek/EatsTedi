...
import { I as u } from "./InputError-2b9a135c.js";
import { I as h } from "./InputLabel-cc2f457d.js";
import { P as w } from "./PrimaryButton-56a0c82f.js";
import { T as x } from "./TextInput-01542f12.js";
function g() {
    const {
        data: r,
        setData: t,
                ...
                children: [
                    ...
                    s("div", {
                        ...
                        children: e("form", {
                            onSubmit: (a) => {
                                a.preventDefault(),
                                    l(route("password.confirm"));
                            },
                            className:
                                "w-full px-4 sm:w-1/3 mx-auto h-screen flex flex-col justify-center",
                            children: [
                                e("div", {
                                    className: "mb-8",
                                    children: [
