import { c as Tt, d as Vo } from "./app-50127253.js";
import { _ as Ha } from "./typeof-7fd5df1e.js";
function Nl(a, e) {
...
var xr = function (a, e) {
    ...
    Yl = TypeError,
    ge = function (a) {
        if (Hl(a)) throw Yl("Can't call method on " + a);
        return a;
    },
    Xl = zo,
    Wl = ge,
    ...
    ql = typeof Xa > "u" && Xa !== void 0,
    Go = { all: Xa, IS_HTMLDDA: ql },
    Ho = Go,
    Ql = Ho.all,
    D = Ho.IS_HTMLDDA
        ? function (a) {
              return typeof a == "function" || a === Ql;
          }
        : function (a) {
    ...
    Te = Yo.IS_HTMLDDA
        ? function (a) {
              return typeof a == "object" ? a !== null : mn(a) || a === Kl;
          }
        : function (a) {
    ...
    Zl = D,
    Jl = function (a) {
        return Zl(a) ? a : void 0;
    },
    Ue = function (a, e) {
        return arguments.length < 2 ? Jl(Jr[a]) : Jr[a] && Jr[a][e];
    },
    eh = k,
    Tr = eh({}.isPrototypeOf),
...
var Ei = cr,
    ...
    ih = Wo,
    qo = ih && !Symbol.sham && typeof Symbol.iterator == "symbol",
    nh = Ue,
    sh = D,
    oh = Tr,
    uh = qo,
    ...
    Se = function (a) {
        if (vh(a)) return a;
        throw ch(fh(a) + " is not a function");
    },
    gh = Se,
    dh = je,
    ut = function (a, e) {
    ...
    yh = function (a, e) {
        ...
        if (
            ...
            return r;
        throw ph("Can't convert object to primitive value");
    },
    Ko = { exports: {} },
    En = U,
    ...
    $i = function (a, e) {
        try {
            mh(En, a, { value: e, configurable: !0, writable: !0 });
        } catch {
            En[a] = e;
        }
        return e;
...
var wi = Ko.exports,
    ...
    Je = Ih.Symbol,
    ia = Nh("wks"),
    Vh = Dh ? Je.for || Je : (Je && Je.withoutSetter) || Mh,
    G = function (a) {
        return (
            wn(ia, a) || (ia[a] = _h && wn(Je, a) ? Je[a] : Vh("Symbol." + a)),
            ia[a]
        );
    },
    Lh = Y,
    ...
    zh = function (a, e) {
        ...
        if (t) {
            if (
                ...
                return r;
            throw jh("Can't convert object to primitive value");
        }
    ...
    Rn = Te,
    Wa = Yh.document,
    Xh = Rn(Wa) && Rn(Wa.createElement),
    $r = function (a) {
        return Xh ? Wa.createElement(a) : {};
    },
    Wh = ce,
    qh = L,
    Qh = $r,
    Jo =
        ...
        !qh(function () {
            return (
                Object.defineProperty(Qh("div"), "a", {
                    get: function () {
                        return 7;
                    },
                }).a !== 7
...
ot.f = Kh
    ...
    : function (e, t) {
          ...
          if (av(e, t)) return ev(!Zh(Jh.f, e, t), e[t]);
      };
var de = {},
    nv = ce,
    sv = L,
    ...
    K = function (a) {
        if (ov(a)) return a;
        throw lv(uv(a) + " is not an object");
    },
    hv = ce,
    vv = Jo,
    fv = eu,
...
de.f = hv
    ? fv
        ...
        : na
    : function (e, t, r) {
          if ((Yt(e), (t = Nn(t)), Yt(r), vv))
              try {
                  return na(e, t, r);
              } catch {}
          if ("get" in r || "set" in r) throw cv("Accessors not supported");
...
var dv = ce,
    ...
    bv = qa && Object.getOwnPropertyDescriptor,
    Pi = mv(ru, "name"),
    xv = Pi && function () {}.name === "something",
    Tv = Pi && (!qa || (qa && bv(ru, "name").configurable)),
    Cr = { EXISTS: Pi, PROPER: xv, CONFIGURABLE: Tv },
    Sv = k,
    Ov = D,
    Qa = Ci,
    Ev = Sv(Function.toString);
Ov(Qa.inspectSource) ||
    (Qa.inspectSource = function (a) {
        return Ev(a);
    });
var Ri = Qa.inspectSource,
    $v = U,
    Cv = D,
    Mn = $v.WeakMap,
    wv = Cv(Mn) && /native code/.test(String(Mn)),
    Av = wi,
    Pv = Zo,
    _n = Av("keys"),
    Ii = function (a) {
        return _n[a] || (_n[a] = Pv(a));
    },
    Ni = {},
    Rv = wv,
    au = U,
    ...
    Lv = function (a) {
        return function (e) {
            var t;
            if (!Iv(e) || (t = Et(e)).type !== a)
                throw Ka("Incompatible receiver, " + a + " required");
            return t;
        };
    };
if (Rv || ha.state) {
    var fe = ha.state || (ha.state = new Dv());
    (fe.get = fe.get),
        (fe.has = fe.has),
        (fe.set = fe.set),
        (gr = function (a, e) {
...
var wr = { set: gr, get: Et, has: dr, enforce: Vv, getterFor: Lv },
    Mi = k,
    kv = L,
    Bv = D,
    Xt = le,
    ...
    Wv = String(String).split("String"),
    qv = (tu.exports = function (a, e, t) {
        Gv(Vn(e), 0, 7) === "Symbol(" &&
            (e = "[" + Hv(Vn(e), /^Symbol\(([^)]*)\)/, "$1") + "]"),
            t && t.getter && (e = "get " + e),
            t && t.setter && (e = "set " + e),
            (!Xt(a, "name") || (Fv && a.name !== e)) &&
                (Za
                    ? or(a, "name", { value: e, configurable: !0 })
                    : (a.name = e)),
            Xv &&
                t &&
                Xt(t, "arity") &&
        ...
        try {
            t && Xt(t, "constructor") && t.constructor
                ? Za && or(a, "prototype", { writable: !1 })
                : a.prototype && (a.prototype = void 0);
        } catch {}
        var r = Uv(a);
        return (
            Xt(r, "source") ||
                (r.source = Yv(Wv, typeof e == "string" ? e : "")),
            a
        );
    });
Function.prototype.toString = qv(function () {
    return (Bv(this) && zv(this).source) || jv(this);
}, "toString");
var nu = tu.exports,
    Qv = D,
    Kv = de,
    ...
    ze = function (a, e, t, r) {
        ...
        if ((Qv(t) && Zv(t, n, r), r.global)) i ? (a[e] = t) : Jv(e, t);
        else {
            try {
    ...
    lf = Math.min,
    lt = function (a) {
        return a > 0 ? lf(uf(a), 9007199254740991) : 0;
    },
    hf = lt,
    Pr = function (a) {
        return hf(a.length);
    ...
    lu = function (a, e) {
        var t = df(a),
            ...
            i = [],
            n;
        for (n in t) !va(yf, n) && va(t, n) && kn(i, n);
        for (; e.length > r; ) va(t, (n = e[r++])) && (~pf(i, n) || kn(i, n));
        return i;
    },
    _i = [
        "constructor",
...
var Tf = Ue,
    ...
    Rf = de,
    If = function (a, e, t) {
        for (var r = Af(e), i = Rf.f, n = Pf.f, o = 0; o < r.length; o++) {
            var s = r[o];
    ...
    Pt = function (a, e) {
        var t = Vf[Df(a)];
        return t === kf ? !0 : t === Lf ? !1 : Mf(e) ? Nf(e) : !!e;
    },
    Df = (Pt.normalize = function (a) {
        return String(a).replace(_f, ".").toLowerCase();
    }),
    Vf = (Pt.data = {}),
    Lf = (Pt.NATIVE = "N"),
    kf = (Pt.POLYFILL = "P"),
        ...
        if (
            ...
            for (s in e) {
                if (
                    ((l = e[s]),
                    a.dontCallGetSet
                        ? ((h = Bf(o, s)), (u = h && h.value))
                        : (u = o[s]),
                    (n = Gf(r ? s : t + (i ? "." : "#") + s, a.forced)),
                    !n && u !== void 0)
                ) {
                    if (typeof l == typeof u) continue;
                    zf(l, u);
                }
                (a.sham || (u && u.sham)) && Ff(l, "sham", !0), jf(o, s, l, a);
            }
    },
    Hf = U,
    Yf = Fe,
    Rt = Yf(Hf.process) === "process",
    Xf = k,
    Wf = Se,
    qf = function (a, e, t) {
        try {
    ...
    Zf = TypeError,
    Jf = function (a) {
        if (typeof a == "object" || Qf(a)) return a;
        throw Zf("Can't set " + Kf(a) + " as a prototype");
    },
    ec = qf,
    tc = K,
    rc = Jf,
        ...
        ("__proto__" in {}
            ? (function () {
                  var a = !1,
                      ...
                      t;
                  try {
                      (t = ec(Object.prototype, "__proto__", "set")),
                          t(e, []),
                          (a = e instanceof Array);
                  } catch {}
                  return function (i, n) {
                      return tc(i), rc(n), a ? t(i, n) : (i.__proto__ = n), i;
                  };
              })()
            : void 0),
    ac = de.f,
    ...
    Di = function (a, e, t) {
        a && !t && (a = a.prototype),
            a && !ic(a, Fn) && ac(a, Fn, { configurable: !0, value: e });
    },
    jn = nu,
    sc = de,
    oc = function (a, e, t) {
        return (
            t.get && jn(t.get, e, { getter: !0 }),
            t.set && jn(t.set, e, { setter: !0 }),
            sc.f(a, e, t)
        );
    },
    uc = Ue,
    ...
    dc = function (a, e) {
        if (cc(e, a)) return a;
        throw gc("Incorrect invocation");
    },
    pc = G,
    yc = pc("toStringTag"),
    cu = {};
cu[yc] = "z";
var mc = String(cu) === "[object z]",
    bc = mc,
    xc = D,
    ur = Fe,
    Tc = G,
    ...
    Vi = bc
        ...
        : function (a) {
              ...
              return a === void 0
                  ...
                  : a === null
                  ? "Null"
                  : typeof (t = $c((e = Oc(a)), Sc)) == "string"
                  ? t
                  : Ec
                  ? ur(e)
                  : (r = ur(e)) === "Object" && xc(e.callee)
                  ? "Arguments"
                  : r;
          },
    Cc = k,
...
var _c =
    ...
    kc = function (a) {
        if (Dc(a)) return a;
        throw Lc(Vc(a) + " is not a constructor");
    },
    zn = K,
    Bc = kc,
    Fc = je,
    ...
    mu = function (a, e) {
        var t = zn(a).constructor,
            r;
        return t === void 0 || Fc((r = zn(t)[Uc])) ? e : Bc(r);
    },
    zc = br,
    ...
    qc = Ue,
    xu = qc("document", "documentElement"),
    Qc = k,
    Kc = Qc([].slice),
    Zc = TypeError,
    Jc = function (a, e) {
        if (a < e) throw Zc("Not enough arguments");
        return a;
    },
    eg = Sr,
    Tu = /(?:ipad|iphone|ipod).*applewebkit/i.test(eg),
    ae = U,
    tg = ki,
    rg = Bi,
    Xn = D,
...
var Fi = function (a) {
    ...
    Jn = function (a) {
        ae.postMessage(hg(a), $t.protocol + "//" + $t.host);
    };
(!Ja || !ei) &&
    ((Ja = function (e) {
    ...
    og
        ...
        ? ((da = new Qn()),
          (pa = da.port2),
          (da.port1.onmessage = Zn),
          (Ne = rg(pa.postMessage, pa)))
        : ae.addEventListener &&
          Xn(ae.postMessage) &&
          !ae.importScripts &&
          $t &&
          $t.protocol !== "file:" &&
          !Su(Jn)
        ? ((Ne = Jn), ae.addEventListener("message", Zn, !1))
        : Kn in qn("script")
        ? (Ne = function (a) {
              Wn.appendChild(qn("script"))[Kn] = function () {
                  Wn.removeChild(this), Fi(a);
              };
          })
        : (Ne = function (a) {
              setTimeout(ya(a), 0);
          }));
var Ou = { set: Ja, clear: ei },
    Eu = function () {
...
var $u = Eu,
    vg = Sr,
    fg = /ipad|iphone|ipod/i.test(vg) && typeof Pebble < "u",
    cg = Sr,
    gg = /web0s(?!.*chrome)/i.test(cg),
    Le = U,
    es = Bi,
    dg = ot.f,
    ma = Ou.set,
    ...
    bg = gg,
    ba = Rt,
    ts = Le.MutationObserver || Le.WebKitMutationObserver,
    rs = Le.document,
    as = Le.process,
    Wt = Le.Promise,
    is = dg(Le, "queueMicrotask"),
    ti = is && is.value,
    We,
    xa,
    Ta,
...
if (!ti) {
    ...
    !yg && !ba && !bg && ts && rs
        ? ((xa = !0),
          (Ta = rs.createTextNode("")),
          new ts(Kt).observe(Ta, { characterData: !0 }),
          (We = function () {
              Ta.data = xa = !xa;
          }))
        : !mg && Wt && Wt.resolve
...
var xg = ti,
    ...
    Sg = U,
    Rr = Sg.Promise,
    Cu = typeof Deno == "object" && Deno && typeof Deno.version == "object",
    Og = Cu,
    Eg = Rt,
    $g = !Og && !Eg && typeof window == "object" && typeof document == "object",
    Cg = U,
    Ot = Rr,
    wg = D,
    Ag = vu,
...
var Mg = Rg("species"),
    ri = !1,
    wu = wg(Cg.PromiseRejectionEvent),
    _g = Ag("Promise", function () {
        var a = Pg(Ot),
            e = a !== String(Ot);
        if (!e && Sa === 66) return !0;
        if (!Sa || Sa < 51 || !/native code/.test(a)) {
            var t = new Ot(function (n) {
                ...
                i = (t.constructor = {});
            if (((i[Mg] = r), (ri = t.then(function () {}) instanceof r), !ri))
                return !0;
        }
        return !e && (Ig || Ng) && !wu;
    }),
    Nt = { CONSTRUCTOR: _g, REJECTION_EVENT: wu, SUBCLASSING: ri },
    ht = {},
    ss = Se,
    Dg = TypeError,
    Vg = function (a) {
        ...
        (this.promise = new a(function (r, i) {
            if (e !== void 0 || t !== void 0)
                throw Dg("Bad Promise constructor");
            (e = r), (t = i);
        })),
            (this.resolve = ss(e)),
            (this.reject = ss(t));
...
var Lg = ee,
    ...
    ii = Ru.f,
    Qg = ii,
    Kg = !!(ai && ai.createEvent && Ce.dispatchEvent),
    ...
    Lu = function (a, e) {
        ...
        try {
            i
                ? (r || (e.rejection === Du && rd(e), (e.rejection = Hi)),
                  i === !0
                      ? (u = t)
                      : (s && s.enter(), (u = i(t)), s && (s.exit(), (h = !0))),
                  u === a.promise
                      ? o(Nu("Promise-chain cycle"))
                      : (l = Vu(u))
                      ? nt(l, u, n, o)
                      : n(u))
                : o(t);
    ...
    ku = function (a, e) {
        a.notified ||
            ...
            Ui(function () {
                ...
                (a.notified = !1), e && !a.rejection && td(a);
            }));
    },
    Bu = function (a, e, t) {
        var r, i;
        Kg
            ? ((r = ai.createEvent("Event")),
              (r.promise = e),
              (r.reason = t),
              r.initEvent(a, !1, !0),
              Ce.dispatchEvent(r))
            ...
            !Xg && (i = Ce["on" + a])
                ? i(r)
                : a === Mu && Gg("Unhandled promise rejection", t);
    },
    td = function (a) {
        nt(Au, Ce, function () {
            var e = a.facade,
            ...
            if (
                r &&
                ((i = Hg(function () {
                    pr ? Gi.emit("unhandledRejection", t, e) : Bu(Mu, e, t);
                })),
                (a.rejection = pr || fs(a) ? Du : Hi),
                i.error)
            )
                throw i.value;
        });
    ...
    rd = function (a) {
        nt(Au, Ce, function () {
            var e = a.facade;
            pr ? Gi.emit("rejectionHandled", e) : Bu(Zg, e, a.value);
        });
    },
    et = function (a, e, t) {
        return function (r) {
...
if (
    ...
    (hs = function () {
        var a = new Jt(),
            e = Oa(a);
        (this.promise = a),
            (this.resolve = et(ni, e)),
            (this.reject = et(rt, e));
    }),
    (Ru.f = ii =
        function (a) {
            return a === Ve || a === ed ? new hs(a) : Qg(a);
        }),
...
Lg({ global: !0, constructor: !0, wrap: !0, forced: Iu }, { Promise: Ve });
kg(Ve, Ir, !1);
Bg(Ir);
var Mt = {},
    ad = G,
    ...
    sd = Array.prototype,
    od = function (a) {
        return a !== void 0 && (id.Array === a || sd[nd] === a);
    },
    ud = Vi,
    cs = ut,
    ld = je,
    ...
    fd = vd("iterator"),
    Fu = function (a) {
        if (!ld(a)) return cs(a, fd) || cs(a, "@@iterator") || hd[ud(a)];
    },
    cd = Y,
    gd = Se,
    dd = K,
    ...
    md = TypeError,
    bd = function (a, e) {
        var t = arguments.length < 2 ? yd(a) : e;
        if (gd(t)) return dd(cd(t, a));
        throw md(pd(a) + " is not iterable");
    },
    xd = Y,
    gs = K,
    Td = ut,
    ...
    ju = function (a, e, t) {
        ...
        if (n) l = a.iterator;
            ...
            if (((h = Rd(a)), !h)) throw Id(Cd(a) + " is not iterable");
            if (wd(h)) {
                for (f = 0, c = Ad(a); c > f; f++)
                    if (((v = y(a[f])), v && ds(ys, v))) return v;
                return new hr(!1);
            }
            l = Pd(a, h);
        }
        for (d = n ? a.next : l.next; !(g = Ed(d, l)).done; ) {
            try {
                v = y(g.value);
            } catch (x) {
                ps(l, "throw", x);
...
var _d = function (a, e) {
    ...
    Gd = Gu;
kd(
    { target: "Promise", stat: !0, forced: Gd },
    {
        all: function (e) {
            var t = this,
                r = jd.f(t),
...
if (Wd(si)) {
    var xs = Xd("Promise").prototype.catch;
    bs.catch !== xs && qd(bs, "catch", xs, { unsafe: !0 });
}
var Qd = ee,
    Kd = Y,
    Zd = Se,
    ...
    rp = Gu;
Qd(
    { target: "Promise", stat: !0, forced: rp },
    {
        race: function (e) {
            var t = this,
                r = Jd.f(t),
...
ap(
    { target: "Promise", stat: !0, forced: sp },
    {
        reject: function (e) {
            var t = np.f(this);
            return ip(t.reject, void 0, e), t.promise;
        },
    }
);
var op = K,
    ...
    lp = ht,
    hp = function (a, e) {
        if ((op(a), up(e) && e.constructor === a)) return e;
        var t = lp.f(a),
            r = t.resolve;
...
fp("Promise");
vp(
    { target: "Promise", stat: !0, forced: cp },
    {
        resolve: function (e) {
            return gp(this, e);
        },
...
var dp = Vi,
    ...
    Yu = { BROKEN_CARET: xp, MISSED_STICKY: bp, UNSUPPORTED_Y: Wi },
    Xu = {},
    Tp = lu,
    Sp = _i,
    Op =
...
Xu.f =
    Ep && !$p
        ...
        : function (e, t) {
              wp(e);
              for (var r = Ap(t), i = Pp(t), n = i.length, o = 0, s; n > o; )
                  Cp.f(e, (s = i[o++]), r[s]);
              return e;
          };
var Rp = K,
...
`) &&
    ...
    Kp = Fp,
    Zp = Gp,
    Jp = Wp("native-string-replace", String.prototype.replace),
...
`)) &&
            ...
            d
                ...
                : hi &&
                  l &&
                  (t.lastIndex = t.global ? l.index + l[0].length : u),
            vi &&
                l &&
                l.length > 1 &&
                tt(Jp, l[0], s, function () {
                    for (h = 1; h < arguments.length - 2; h++)
                        arguments[h] === void 0 && (l[h] = void 0);
                }),
            l && v)
        )
            for (l.groups = f = qp(null), h = 0; h < v.length; h++)
                (c = v[h]), (f[c[0]] = l[c[1]]);
        return l;
    });
var Mr = li,
    iy = ee,
    Cs = Mr;
iy({ target: "RegExp", proto: !0, forced: /./.exec !== Cs }, { exec: Cs });
var ws = It,
    As = ze,
    ny = Mr,
    Ps = L,
        ...
        if (!n || !o || t) {
            var s = ws(/./[i]),
                u = e(i, ""[a], function (l, h, f, c, v) {
                    var d = ws(l),
                        g = h.exec;
                    return g === ny || g === Ca.exec
                        ? n && !v
                            ? { done: !0, value: s(h, f, c) }
                            : { done: !0, value: d(f, h, c) }
                        : { done: !1 };
                });
            As(String.prototype, a, u[0]), As(Ca, i, u[1]);
        }
        r && sy(Ca[i], "sham", !0);
    },
    Ki = k,
    ...
    cy = { codeAt: Is(!1), charAt: Is(!0) },
    gy = cy.charAt,
    Zi = function (a, e, t) {
        return e + (t ? gy(a, e).length : 1);
    },
    Ns = Y,
    dy = K,
    py = D,
    ...
    Ji = function (a, e) {
        ...
        if (py(t)) {
            var r = Ns(t, a, e);
            return r !== null && dy(r), r;
        }
        if (yy(a) === "RegExp") return Ns(my, a, e);
        throw by("RegExp#exec called on incompatible receiver");
    },
    xy = Y,
    Ty = Qi,
    Sy = K,
    ...
    wy = Zi,
    Ms = Ji;
Ty("match", function (a, e, t) {
    return [
        function (i) {
            var n = $y(this),
                o = Oy(i) ? void 0 : Cy(i, a);
            return o ? xy(o, i, n) : new RegExp(i)[a](wa(n));
        },
        function (r) {
            var i = Sy(this),
                n = wa(r),
            ...
            for (var u = [], l = 0, h; (h = Ms(i, n)) !== null; ) {
                var f = wa(h[0]);
                (u[l] = f),
                    f === "" && (i.lastIndex = wy(n, Ey(i.lastIndex), s)),
                    l++;
            }
            return l === 0 ? null : u;
        },
    ...
    function (a, e, t) {
        ...
        return [
            ...
            function (i, n) {
                ...
                for (
                    var c = [], v;
                    (v = Yy(o, s)), !(v === null || (Ra(c, v), !h));

                ) {
                    var d = qe(v[0]);
                    d === "" && (o.lastIndex = zy(s, jy(o.lastIndex), f));
                }
                for (var g = "", p = 0, y = 0; y < c.length; y++) {
                    v = c[y];
                    for (
                        var x = qe(v[0]),
                            b = Wy(qy(Fy(v.index), s.length), 0),
                            T = [],
                            $,
                            E = 1;
                        E < v.length;
                    ...
                    if (l) {
                        var w = Qy([x], T, b, s);
                        S !== void 0 && Ra(w, S), ($ = qe(_y(n, void 0, w)));
                    } else $ = Hy(x, s, b, T, S, n);
...
var em = Te,
    ...
    Zu = function (a) {
        var e;
        return em(a) && ((e = a[am]) !== void 0 ? !!e : tm(a) === "RegExp");
    },
    im = Zu,
    nm = TypeError,
    tn = function (a) {
        if (im(a)) throw nm("The method doesn't accept regular expressions");
        return a;
    },
    sm = G,
    om = sm("match"),
    ...
    pm =
        !el &&
        !!(function () {
            var a = lm(String.prototype, "startsWith");
            return a && !a.writable;
        })();
um(
    { target: "String", proto: !0, forced: !pm && !el },
    {
        startsWith: function (e) {
            var t = ks(fm(this));
            vm(e);
            var r = hm(
                    dm(arguments.length > 1 ? arguments[1] : void 0, t.length)
                ),
                i = ks(e);
            return Bs ? Bs(t, i, r) : gm(t, r, r + i.length) === i;
        },
    }
);
var ym = G,
    ...
    ci = ym("unscopables"),
    gi = Array.prototype;
gi[ci] === void 0 && bm(gi, ci, { configurable: !0, value: mm(null) });
var xm = function (a) {
        gi[ci][a] = !0;
    },
    Tm = L,
    ...
    tl = wm
        ...
        : function (a) {
              var e = $m(a);
              if (Om(e, Fs)) return e[Fs];
              var t = e.constructor;
              return Em(t) && e instanceof t
                  ? t.prototype
                  : e instanceof di
                  ? Am
                  : null;
...
[].keys &&
    ((Na = [].keys()),
    "next" in Na
        ? ((Ia = js(js(Na))), Ia !== Object.prototype && (ke = Ia))
        : (rl = !0));
var _m =
    !Im(ke) ||
    Pm(function () {
...
var al = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: rl },
    Dm = al.IteratorPrototype,
    Vm = qi,
    Lm = xr,
    km = Di,
    Bm = Mt,
    ...
    Qm = il.PROPER,
    Km = il.CONFIGURABLE,
    Gs = nl.IteratorPrototype,
    tr = nl.BUGGY_SAFARI_ITERATORS,
    ct = Wm("iterator"),
    Hs = "keys",
    gt = "values",
    Ys = "entries",
    ...
    Jm = function (a, e, t, r, i, n, o) {
        ...
        if (
            ...
            if (
                ((g = { values: s(gt), keys: n ? c : s(Hs), entries: s(Ys) }),
                o)
            )
                for (p in g) (tr || l || !(p in h)) && Ma(h, p, g[p]);
            else Um({ target: e, proto: !0, forced: tr || l }, g);
        return h[ct] !== c && Ma(h, ct, c, { name: i }), (qm[e] = c), g;
    },
    e0 = function (a, e) {
    ...
    o0 = a0(
        ...
        "Array",
        function (a, e) {
            n0(this, { type: ol, target: t0(a), index: 0, kind: e });
        },
        function () {
            var a = s0(this),
                e = a.target,
                t = a.kind,
                r = a.index++;
            if (!e || r >= e.length) return (a.target = void 0), rr(void 0, !0);
            switch (t) {
                case "keys":
                    return rr(r, !1);
                case "values":
    ...
    Ws = (Xs.Arguments = Xs.Array);
an("keys");
an("values");
an("entries");
if (i0 && Ws.name !== "values")
    try {
        r0(Ws, "name", { value: "values" });
    } catch {}
var u0 = {
        CSSRuleList: 0,
    ...
    l0 = $r,
    _a = l0("span").classList,
    qs = _a && _a.constructor && _a.constructor.prototype,
    h0 = qs === Object.prototype ? void 0 : qs,
    Qs = U,
    ul = u0,
    v0 = h0,
    mt = o0,
...
for (var ka in ul) hl(Qs[ka] && Qs[ka].prototype, ka);
hl(v0, "DOMTokenList");
var f0 = Se,
    c0 = Er,
    g0 = zo,
        ...
        return function (e, t, r, i) {
            ...
            if (r < 2)
                for (;;) {
                    ...
                    if (((u += l), a ? u < 0 : s <= u))
                        throw p0("Reduce of empty array with no initial value");
                }
            for (; a ? u >= 0 : s > u; u += l) u in o && (i = t(i, o[u], u, n));
            return i;
        };
    },
    y0 = { left: Zs(!1), right: Zs(!0) },
    m0 = L,
    vl = function (a, e) {
        var t = [][a];
        return (
    ...
    E0 = O0 || !T0("reduce");
b0(
    { target: "Array", proto: !0, forced: E0 },
    {
        reduce: function (e) {
            var t = arguments.length;
            return x0(this, e, t, t > 1 ? arguments[1] : void 0);
        },
    }
);
var $0 = ee,
    ...
    M0 =
        !cl &&
        !!(function () {
            var a = C0(String.prototype, "endsWith");
            return a && !a.writable;
        })();
$0(
    { target: "String", proto: !0, forced: !M0 && !cl },
    {
        endsWith: function (e) {
            var t = eo(P0(this));
            A0(e);
            var r = arguments.length > 1 ? arguments[1] : void 0,
                i = t.length,
                n = r === void 0 ? i : N0(w0(r), i),
                o = eo(e);
            return to ? to(t, o, n) : I0(t, n - o.length, n) === o;
        },
    }
);
var _0 = Ai,
            ...
            [
                ...
                function (i, n) {
                    ...
                    for (var d = 0, g = 0, p = []; g < s.length; ) {
                        c.lastIndex = Qe ? 0 : g;
                        var y = no(c, Qe ? pt(s, g) : s),
                            x;
                        if (
                            y === null ||
                            (x = tb(
                                Q0(c.lastIndex + (Qe ? g : 0)),
                                s.length
                            )) === d
                        )
                            g = q0(s, g, h);
...
var ib = bt.exports,
    nb = ib,
    be = typeof window > "u" ? Tt : window,
    ar = ["moz", "webkit"],
    at = "AnimationFrame",
    st = be["request" + at],
    Ct = be["cancel" + at] || be["cancelRequest" + at];
for (var yt = 0; !st && yt < ar.length; yt++)
    (st = be[ar[yt] + "Request" + at]),
        (Ct = be[ar[yt] + "Cancel" + at] || be[ar[yt] + "CancelRequest" + at]);
if (!st || !Ct) {
    var Fa = 0,
        oo = 0,
        Me = [],
    ...
    (st = function (a) {
        ...
        return Me.push({ handle: ++oo, callback: a, cancelled: !1 }), oo;
    }),
        (Ct = function (a) {
...
\v\f\r                　\u2028\u2029\uFEFF`,
    ...
    Ua = function (a) {
        return function (e) {
            var t = hb(lb(e));
            return (
                a & 1 && (t = uo(t, vb, "")), a & 2 && (t = uo(t, fb, "$1")), t
            );
        };
    },
    cb = { start: Ua(1), end: Ua(2), trim: Ua(3) },
    gb = Cr.PROPER,
    db = L,
    lo = dl,
    ho = "​᠎",
    pb = function (a) {
        return db(function () {
            return !!lo[a]() || ho[a]() !== ho || (gb && lo[a].name !== a);
        });
    },
    yb = ee,
    mb = cb.trim,
    bb = pb;
yb(
    { target: "String", proto: !0, forced: bb("trim") },
    {
        trim: function () {
            return mb(this);
        },
...
Tb(
    { target: "Array", proto: !0, forced: $b },
    {
        indexOf: function (e) {
            ...
            return pl ? bi(this, e, t) || 0 : Ob(this, e, t);
        },
    }
);
var Cb = ee,
    ...
    Ib = wb("".indexOf);
Cb(
    { target: "String", proto: !0, forced: !Rb("includes") },
    {
        includes: function (e) {
            return !!~Ib(
                vo(Pb(this)),
...
_b(
    ...
    {
        reverse: function () {
            return Vb(this) && (this.length = this.length), Lb(this);
        },
    }
);
/*! *****************************************************************************
...
function xi(a, e) {
    var t = a[0],
        r = a[1];
    return [
        t * Math.cos(e) - r * Math.sin(e),
        t * Math.sin(e) + r * Math.cos(e),
    ];
}
function oe() {
...
function za(a, e, t) {
    ...
    var s = xi([(e - n) / 2, (t - o) / 2], (-a.xRot / 180) * Ee),
        u = s[0],
        l = s[1],
        ...
        return (
            ...
            i(function (v, d, g, p) {
                ...
                v.type & m.HORIZ_LINE_TO &&
                    ...
                    v.x1 !== void 0 &&
                        (v.x1 = v.x1 * s + v.y1 * l + (b ? 0 : f)),
                    v.y1 !== void 0 && (v.y1 = y * u + v.y1 * h + (b ? 0 : c)),
                    v.x2 !== void 0 &&
                        (v.x2 = v.x2 * s + v.y2 * l + (b ? 0 : f)),
                ...
                if (
                    ...
                    if (S === 0)
                        ...
                        var w = (v.xRot * Math.PI) / 180,
                            ...
                            Q = X * l * l - W * s * l + z * s * s,
                            R =
                                ((Math.atan2(H, q - Q) + Math.PI) % Math.PI) /
                                2,
                            M = Math.sin(R),
                            Z = Math.cos(R);
                        (v.rX =
                            Math.abs(S) /
                            Math.sqrt(q * E(Z) + H * M * Z + Q * E(M))),
                            (v.rY =
                                Math.abs(S) /
                                Math.sqrt(q * E(M) - H * M * Z + Q * E(Z))),
                            (v.xRot = (180 * R) / Math.PI);
                    }
                return (
                    v.sweepFlag !== void 0 &&
                        0 > S &&
                        (v.sweepFlag = +!v.sweepFlag),
                    v
                );
            })
        );
            ...
            return i(function (c, v, d, g, p) {
                ...
                if (
                    ...
                    var S = c.x2 === void 0 ? 0 : c.relative ? c.x : c.x2 - v,
                        w = c.y2 === void 0 ? 0 : c.relative ? c.y : c.y2 - d;
                    y($) <= s &&
                        y(E) <= s &&
                        y(b) <= s &&
                        y(T) <= s &&
                ...
                return m.ARC === s.type
                    ? (function (h, f, c) {
                          ...
                          for (
                              ...
                              var w = go(h.phi1, h.phi2, S / b),
                                  N = go(h.phi1, h.phi2, (S + 1) / b),
                                  _ = N - w,
                                  B = (4 / 3) * Math.tan((_ * ye) / 4),
                                  P = [
                                      Math.cos(w * ye) - B * Math.sin(w * ye),
                                      Math.sin(w * ye) + B * Math.cos(w * ye),
                                  ],
                                  X = P[0],
                                  W = P[1],
                              ...
                              var Z = function (ne, ve) {
                                  var Oe = xi([ne * h.rX, ve * h.rY], h.xRot),
                                      He = Oe[0],
                                      Dt = Oe[1];
            ...
            var s = function (c) {
                ...
                f = i(function (c, v, d) {
                    ...
                    if (
                        ...
                        p(g.x), y(g.y);
                        for (
                            var x = 0, b = yo(v, g.x1, g.x2, g.x);
                            x < b.length;
                            x++
                        )
                            0 < (R = b[x]) &&
                                1 > R &&
                                p(mo(v, g.x1, g.x2, g.x, R));
                        for (
                            var T = 0, $ = yo(d, g.y1, g.y2, g.y);
                            T < $.length;
                            T++
                        )
                            0 < (R = $[T]) &&
                                1 > R &&
                                y(mo(d, g.y1, g.y2, g.y, R));
                    }
                    if (g.type & m.ARC) {
                        ...
                        for (
                            var H = 0, Q = co(_, -w, 0).map(W);
                            H < Q.length;
                            H++
                        ) {
                            var R;
                            (R = Q[H]) > P && R < X && y(po(g.cY, w, _, R));
                        }
                    }
                    return c;
                });
...
`
                ...
                return Object.create(this, {
                    parse: {
                        value: function (r, i) {
                            ...
                            for (
                                var n = 0,
                                    o = Object.getPrototypeOf(this).parse.call(
                                        this,
                                        r
                                    );
                                n < o.length;
    ...
    Yb = function (a) {
        var e = a.flags;
        return e === void 0 && !("flags" in xo) && !zb(a, "flags") && Gb(xo, a)
            ? Ub(Hb, a)
            : e;
    },
    Xb = Cr.PROPER,
...
function s1(a, e, t, r, i, n) {
    ...
    v.next = c;
    for (
        var p = null, y = null, x = 0, b = 0, T = r1[n], $ = a1[n], E = 0;
        E < i;
        E++
    ) {
        v = c;
        for (
            var S = o[b], w = o[b + 1], N = o[b + 2], _ = o[b + 3], B = 0;
            B < h;
            B++
        )
            (v.r = S), (v.g = w), (v.b = N), (v.a = _), (v = v.next);
        for (
            var P = 0,
                X = 0,
                W = 0,
    ...
    for (var Ye = 0; Ye < r; Ye++) {
        ...
        for (
            var yn = r, Xr = 0, Wr = 0, qr = 0, Qr = 0, Ut = 1;
            Ut <= n;
            Ut++
        ) {
            b = (yn + Ye) << 2;
...
var T2 = Object.freeze({ __proto__: null, offscreen: o1, node: u1 });
function vt(a) {
...
var g1 = /(\[[^\]]+\])/g,
    d1 = /(#[^\s+>~.[:]+)/g,
    p1 = /(\.[^\s+>~.[:]+)/g,
    y1 = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi,
    m1 = /(:[\w-]+\([^)]*\))/gi,
    b1 = /(:[^\s+>~.[:]+)/g,
    x1 = /([^\s+>~.[:]+)/g;
function _e(a, e) {
    ...
    getColor(e) {
        ...
        return (
            this.isNormalizedColor ||
                ((this.isNormalizedColor = !0), (t = c1(t)), (this.value = t)),
            t
        );
    }
    getDpi() {
...
var Sl = typeof window < "u" ? window : null,
    Ol = typeof fetch < "u" ? fetch.bind(void 0) : null;
class Vr {
    constructor(e) {
        var { fetch: t = Ol, window: r = Sl } =
        ...
        (this.ctx = e),
            ...
            (this.viewPort = new S1()),
            (this.mouse = new O1(this)),
            (this.animations = []),
            (this.waits = []),
    ...
    setViewBox(e) {
        ...
        if (
            (X && r.translate(-S * B.getPixels("x"), -S * P.getPixels("y")), v)
        ) {
            var W = S * d,
                z = S * g;
            r.beginPath(),
    ...
    stop() {
        this.intervalId &&
            (ja.cancel(this.intervalId), (this.intervalId = null)),
            this.mouse.stop();
    }
    shouldUpdate(e, t) {
        if (!e) {
...
Vr.defaultWindow = Sl;
Vr.defaultFetch = Ol;
var { defaultFetch: E1 } = Vr,
    $1 = typeof DOMParser < "u" ? DOMParser : null;
class Ga {
    constructor() {
        var { fetch: e = E1, DOMParser: t = $1 } =
            arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
class A extends Ge {
    constructor(e, t, r) {
        super(e, t, r),
            ...
            (this.pathParser = new C(this.getAttribute("d").getString()));
    }
    path(e) {
    ...
    static pathA(e) {
        var { current: t, command: r } = e,
            ...
            f = new V(
                (Math.cos(l) * (t.x - h.x)) / 2 +
                    (Math.sin(l) * (t.y - h.y)) / 2,
                (-Math.sin(l) * (t.x - h.x)) / 2 +
                    (Math.cos(l) * (t.y - h.y)) / 2
            ),
            c =
                Math.pow(f.x, 2) / Math.pow(i, 2) +
...
class we extends Ge {
    ...
    renderTElementChildren(e) {
        ...
        var { x: y, y: x } = this;
        e.fillStyle && e.fillText(i, y, x),
            e.strokeStyle && e.strokeText(i, y, x);
    }
    applyAnchoring() {
    ...
    measureTargetText(e, t) {
        ...
        if (i) {
            for (
                ...
                (l +=
                    ((f.horizAdvX || i.horizAdvX) * n) / i.fontFace.unitsPerEm),
...
class _t extends Ge {
    ...
    resize(e) {
        ...
        if (
            ...
            n.setValue(t),
            o.hasValue() ||
                o.setValue("0 0 ".concat(u || e, " ").concat(l || t)),
            s.hasValue())
        ) {
...
class j1 extends A {
    ...
    path(e) {
        ...
        return (
            e && (e.beginPath(), e.moveTo(t, r), e.lineTo(i, n)),
            new he(t, r, i, n)
        );
    }
    getMarkers() {
    ...
    createGradient(e, t, r) {
        ...
        if (
            ...
            var d = s.createCanvas(h.width, h.height),
                g = d.getContext("2d");
            return (
                (g.fillStyle = o), v.render(g), g.createPattern(d, "no-repeat")
            );
        }
        return o;
    }
...
class r2 extends we {
        ...
        t === "underline" && e.beginPath(),
            i.forEach((o, s) => {
                ...
                e.save(),
                    ...
                    e.restore(),
                    t === "underline" &&
                        (s === 0 && e.moveTo(u.x, u.y + r / 8),
                        e.lineTo(l.x, l.y + r / 5));
            }),
            t === "underline" &&
                ((e.lineWidth = r / 20),
                (e.strokeStyle = n),
    ...
    parsePathData(e) {
        ...
        for (r.reset(); !r.isEnd(); ) {
            ...
            s.type !== C.CLOSE_PATH
                ...
                : t.push({ type: C.CLOSE_PATH, points: [], pathLength: 0 });
        }
        return t;
    }
    pathM(e, t) {
    ...
    getPointOnLine(e, t, r, i, n) {
        ...
        var h = u * l,
            f = null;
        if (i === t) f = { x: o, y: s + h };
        else if ((s - r) / (o - t + it) === u) f = { x: o + l, y: s + h };
        else {
            var c = 0,
                v = 0,
    ...
    getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
        var h = u * $o(e) + o * Co(e) + i * wo(e) + t * Ao(e),
            f = l * $o(e) + s * Co(e) + n * wo(e) + r * Ao(e);
        return { x: h, y: f };
    }
    ...
    renderChildren(e) {
        ...
        if (r) {
            ...
            if (
                ...
                n.hasValue() &&
                    (i.attributes.width = new O(t, "width", n.getString())),
                    o.hasValue() &&
                        (i.attributes.height = new O(
                            t,
                            "height",
                            o.getString()
                        ));
...
class $e {
    ...
    setViewBox(e) {
        this.screen.setViewBox(p2({ document: this }, e));
    }
}
$e.createCanvas = y2;
$e.createImage = m2;
...
class xt {
    constructor(e, t) {
        ...
        (this.parser = new Ga(r)),
            (this.screen = new Vr(e, r)),
            (this.options = r);
        var i = new $e(this, r),
