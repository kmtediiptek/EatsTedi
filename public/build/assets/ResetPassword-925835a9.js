...
import { I as m } from "./InputError-2b9a135c.js";
import { I as i } from "./InputLabel-cc2f457d.js";
import { P as v } from "./PrimaryButton-56a0c82f.js";
import { T as n } from "./TextInput-01542f12.js";
import { G as g } from "./Guest-6478bd00.js";
import "./index-f4d5d2b2.js";
function b({ token: t, email: d }) {
    const {
        data: r,
        setData: c,
        post: p,
        ...
        errors: l,
        reset: u,
    } = f({ token: t, email: d, password: "", password_confirmation: "" });
    h.useEffect(
        () => () => {
    ...
    const o = (a) => {
        c(a.target.name, a.target.value);
    };
    return e(x, {
        children: [
            s(N, { title: "Reset Password" }),
            e("div", {
                className: "flex",
                children: [
                    e("div", {
                    ...
                    s("div", {
                        ...
                        children: e("form", {
                            onSubmit: (a) => {
                                a.preventDefault(), p(route("password.store"));
                            },
                            className:
