import { W as c, j as s, F as u, a as e, b as p } from "./app-50127253.js";
import { I as h } from "./InputError-2b9a135c.js";
import { P as f } from "./PrimaryButton-56a0c82f.js";
import { T as w } from "./TextInput-01542f12.js";
import { G as x } from "./Guest-6478bd00.js";
import { _ as g } from "./index-f4d5d2b2.js";
function N({ status: a }) {
    const {
            data: t,
            setData: r,
        ...
        n = (l) => {
            r(l.target.name, l.target.value);
        },
        d = (l) => {
            l.preventDefault(), o(route("password.email"));
        };
    return s(u, {
        children: [
            e(p, { title: "Forgot Password" }),
            a && g.success(a),
            s("div", {
                className: "flex",
                children: [
                    ...
                    e("div", {
                        ...
                        children: s("form", {
                            ...
                            children: [
                                ...
                                e(h, { message: m.email, className: "mt-2" }),
                                e("div", {
                                    className:
